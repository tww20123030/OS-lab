...
.LM2:
	leal	20(%ebp), %ebx
	.stabn	68,0,98,.LM3-.LFBB1
.LM3:
	movl	%eax, 8(%esp)
	movl	8(%ebp), %eax
	movl	%eax, 4(%esp)
	call	cprintf
	.stabn	68,0,99,.LM4-.LFBB1
.LM4:
	movl	16(%ebp), %eax
	movl	%ebx, 4(%esp)
	movl	%eax, (%esp)
	call	vcprintf
	.stabn	68,0,100,.LM5-.LFBB1
.LM5:
	movl	$.LC1, (%esp)
	call	cprintf
	.stabn	68,0,102,.LM6-.LFBB1
.LM6:
	addl	$20, %esp
	popl	%ebx
	popl	%ebp
...
.LFBB4:
	pushl	%ebp
	.stabn	68,0,28,.LM27-.LFBB4
.LM27:
	xorl	%eax, %eax
	.stabn	68,0,24,.LM28-.LFBB4
.LM28:
	movl	%esp, %ebp
	.stabn	68,0,28,.LM29-.LFBB4
.LM29:
	movl	$256, %edx
...
.LM30:
	pushl	%edi
	pushl	%ebx
	.stabn	68,0,28,.LM31-.LFBB4
.LM31:
	leal	-266(%ebp), %ebx
	.stabn	68,0,24,.LM32-.LFBB4
.LM32:
	subl	$288, %esp
	.stabn	68,0,28,.LM33-.LFBB4
.LM33:
	testb	$2, %bl
	movl	%ebx, %edi
	movb	$0, -9(%ebp)
...
.LM43:
	...
	movl	$.LC9, (%esp)
	call	cprintf
	.stabn	68,0,44,.LM44-.LFBB4
.LM44:
	movsbl	-9(%ebp),%eax
	movl	$.LC10, (%esp)
	movl	%eax, 4(%esp)
	call	cprintf
	.stabn	68,0,45,.LM45-.LFBB4
.LM45:
	movl	$-1024, 8(%esp)
	movl	$1024, 4(%esp)
	movl	$.LC11, (%esp)
	call	cprintf
	.stabn	68,0,49,.LM46-.LFBB4
.LM46:
	movl	$5, (%esp)
	call	test_backtrace
	.p2align 4,,7
	.p2align 3
.L17:
	.stabn	68,0,53,.LM47-.LFBB4
.LM47:
	movl	$0, (%esp)
	call	monitor
	jmp	.L17
.L19:
	.stabn	68,0,28,.LM48-.LFBB4
.LM48:
	stosw
	movw	$254, %dx
	.p2align 4,,2
